...
console.log("ResearchUsdEMT deployed at:", token.address);
console.log("Holder balance:", formatUnits(await token.read.balanceOf([holder.account.address]), 6), "rUSD");
console.log("Merchant balance:", formatUnits(await token.read.balanceOf([merchant.account.address]), 6), "rUSD");
console.log("Total supply:", formatUnits(await token.read.totalSupply(), 6), "rUSD");
